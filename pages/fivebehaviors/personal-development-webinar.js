...
export default function FIveBWorkshop(){
    ...
    const FiveBPersonalD = async event => {
        ...
        xhttp.open("Post", 'https://ajrkhan.xyz/everythingdisc/wp-json/contact-form-7/v1/contact-forms/258/feedback');
                    ...
                    <div className="row y-middle">
                        <div className="col-md-7 col-sm-12">
                            <div className="content-wrap">                                
                                ...
                                <h3 className="colorw">Date: 25th February, 2022 Time: Time: 3 PM – 4 PM</h3>                                
                            </div>
                        </div>
