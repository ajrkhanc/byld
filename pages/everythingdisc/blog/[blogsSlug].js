...
export async function getServerSideProps(context) {
    ...
    const res = await fetch(`https://sea-turtle-app-g9q6j.ondigitalocean.app/api/post/${posturl}`)
    const posts = await res.json()

    const getfeedback = await fetch(`https://sea-turtle-app-g9q6j.ondigitalocean.app/api/posts/feed/${posturl}`)
...
const submitFeedback = async (event) => {
    ...
    xhr.open('POST', 'https://sea-turtle-app-g9q6j.ondigitalocean.app/api/feedback/');
