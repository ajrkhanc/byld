...
export async function getServerSideProps(context) {
    const post5 = await fetch('https://everythingdisc-admins.herokuapp.com/api/posts')
    ...
    const res = await fetch(`https://everythingdisc-admins.herokuapp.com/api/post/${posturl}`)
    const posts = await res.json()

    const getfeedback = await fetch(`https://everythingdisc-admins.herokuapp.com/api/posts/feed/${posturl}`)
