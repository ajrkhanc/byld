...
export async function getServerSideProps(context) {
    ...
    const res = await fetch(`https://clblogs-zavr.onrender.com/api/career-coaching-snapshot/${caturl}`)
...
export default function result({ result }) {
    ...
    return (
        <>
            ...
            <Head>
                <title>Result | Career Coaching Snapshot Internal Assessment</title>
