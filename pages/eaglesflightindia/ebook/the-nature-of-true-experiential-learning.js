...
export default function Ebookpage(){
        ...
        xhttp.onreadystatechange = function () {
            if (xhttp.readyState == 4) {
                if (xhttp.status == 200) {
                    ...
                    setTimeout(function() {
                        window.open("/efassets/pdf/experiential-learning-white-paper.pdf", "_blank")
                     }, 3000);
    ...
    return(
        <>
          <Head>
            <title>The Nature Of True Experiential Learning - Eagle’s Flight</title>
            ...
            <div className="container">
                <div className="row y-middle">
                    <div className="col-lg-12">
                      ...
                      <h4 className="countertoph2 text-center font30">The Nature Of True Experiential Learning</h4>
            ...
            <div className="container">
                <div className="row rs-vertical-middle">                    
                    <div className="col-lg-6 pr-0">
                        ...
                        <h4 className="countertoph2 text-left font24">The Nature Of True Experiential Learning</h4>
                        <p className='mall5'>
                            ...
                            <form id="contactForm" className='clientcornner pbb-20' onSubmit={EbookSubmit}>                                         
                                    <div className="row">
                                        ...
                                        <div className="col-sm-12 mb-12 d-none">
                                            <input type="text" name="formname" value="The Nature Of True Experiential Learning"/>
                                        </div>
                                        <div className="col-sm-12 mb-12 d-none">
