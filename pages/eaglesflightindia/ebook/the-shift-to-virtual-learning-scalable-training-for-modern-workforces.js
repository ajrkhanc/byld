...
export default function Ebookpage(){
    ...
    return(
        <>
          <Head>
            <title>The Shift to Virtual Learning - Eagle’s Flight</title>
            ...
            <div className="container">
                <div className="row y-middle">
                    <div className="col-lg-12">
                      ...
                      <h4 className="countertoph2 text-center font30">The Shift to Virtual Learning</h4>
            ...
            <div className="container">
                <div className="row rs-vertical-middle">                    
                    <div className="col-lg-6 pr-0">
                        ...
                        <h4 className="countertoph2 text-left font24">The Shift to Virtual Learning: Scalable Training for Modern Workforces</h4>
                        <p className='mall5'>
                        ...
                        <h4 className="countertoph2 text-left font18">Chapters cover topics such as:</h4>
                        <ul className="estimate-info">
                            <li>Workplace trends influencing the shift to virtual learning</li>
                            <li>Pitfalls to avoid when building a virtual learning program</li>
                            <li>How to ensure learner engagement in an online setting</li>
                            <li>Popular competency development topics for virtual learning</li>
                            <li>What to look for in a virtual training and development partner</li>                            
                        </ul>
                        </div>
                        </div>
                    </div>
                            ...
                            <form id="contactForm" className='clientcornner pbb-20' onSubmit={EbookSubmit}>                                         
                                    <div className="row">
                                        ...
                                        <div className="col-sm-12 mb-12 d-none">
                                            <input type="text" name="formname" value="The Shift to Virtual Learning"/>
                                        </div>
                                        <div className="col-sm-12 mb-12 d-none">
