...
export default function Ebookpage(){
    ...
    return(
        <>
          <Head>
            <title>Virtual Team-Building - Eagle’s Flight</title>
            ...
            <div className="container">
                <div className="row y-middle">
                    <div className="col-lg-12">
                      ...
                      <h4 className="countertoph2 text-center font30">Virtual Team-Building</h4>
            ...
            <div className="container">
                <div className="row rs-vertical-middle">                    
                    <div className="col-lg-6 pr-0">
                        ...
                        <h4 className="countertoph2 text-left font24">Using Experiential Learning to Increase Collaboration in a Remote Workplace</h4>
                        <p className='mall5'>
                        While remote work has been on the rise for years, COVID-19 dramatically and irreversibly changed where and how we work.
                        </p>
                        <p className='mall5'>
                            ...
                            <form id="contactForm" className='clientcornner pbb-20' onSubmit={EbookSubmit}>                                         
                                    <div className="row">
                                        ...
                                        <div className="col-sm-12 mb-12 d-none">
                                            <input type="text" name="formname" value="Virtual Team-Building"/>
                                        </div>
                                        <div className="col-sm-12 mb-12 d-none">
