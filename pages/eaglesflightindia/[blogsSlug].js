...
export async function getServerSideProps(context) {
    const post5 = await fetch('https://eaglesflightindiablog-n8dyg.ondigitalocean.app/api/posts')
    const posts5 = await post5.json()

    const cat = await fetch('https://eaglesflightindiablog-n8dyg.ondigitalocean.app/api/categories')
    const cats = await cat.json()


    const posturl = context.params.blogsSlug;
    const res = await fetch(`https://eaglesflightindiablog-n8dyg.ondigitalocean.app/api/post/${posturl}`)
    const posts = await res.json()

    const getfeedback = await fetch(`https://eaglesflightindiablog-n8dyg.ondigitalocean.app/api/posts/feed/${posturl}`)
...
const submitFeedback = async (event) => {
    ...
    xhr.open('POST', 'https://eaglesflightindiablog-n8dyg.ondigitalocean.app/api/feedback/');
                        ...
                        <div class="col-lg-4 col-md-12 order-last">
                            ...
                            <div class="recent-posts mb-50">
                                ...
                                <div class="recent-post-widget">
                                    <div class="post-img">
                                        <a href={`/eaglesflightindia/${getpost.posturl}`}>
                                        <img src={getpost.ImageURL} alt={getpost.ImageAlt} />
                                        </a>
                                    </div>
                                    <div class="post-desc">
                                        <a href={`/eaglesflightindia/${getpost.posturl}`}>{getpost.Title}</a>
                            ...
                            <div class="categories">
                                ...
                                <ul>
                                    ...
                                    cats.map((getcats) => {
                                    return (
                                    <li><a href={`/eaglesflightindia/category/${getcats.Caturl}`}>{getcats.Name}</a></li>
                                    );
                                    })
                                    }
                                </ul>
