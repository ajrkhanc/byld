        ...
        xhttp.onreadystatechange = function () {
            if (xhttp.readyState == 4) {
                if (xhttp.status == 200) {
                    ...
                    setTimeout(function() {
                        window.open("/assets/pdf/inout-creating-coaching-culture.pdf", "_blank")
                     }, 3000);
            ...
            <div className="container">
                <div className="row y-middle">
                    <div className="col-lg-12">
                      ...
                      <h4 className="countertoph2 text-center font30">Creating a Coaching Culture</h4>
                            ...
                            <form id="contact-form" className='clientcornner pbb-20' onSubmit={EbookSubmit}>                                         
                                    <div className="row">
                                        ...
                                        <div className="col-sm-12 mb-12 d-none">
                                            <input type="text" name="formname" value="Creating a Coaching Culture"/>
                                        </div>
                                        <div className="col-sm-12 mb-12 d-none">
