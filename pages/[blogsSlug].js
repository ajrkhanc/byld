...
export async function getServerSideProps(context) {
    ...
    const getfeedback = await fetch(`https://coral-app-5w4lr.ondigitalocean.app/api/posts/feed/${posturl}`)
...
const submitFeedback = async (event) => {
    ...
    xhr.open('POST', 'https://coral-app-5w4lr.ondigitalocean.app/api/feedback/');
