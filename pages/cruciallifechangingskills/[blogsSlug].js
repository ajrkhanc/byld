...
export async function getServerSideProps(context) {
    const post5 = await fetch('https://coral-app-2-a333o.ondigitalocean.app/api/posts')
    const posts5 = await post5.json()

    const cat = await fetch('https://coral-app-2-a333o.ondigitalocean.app/api/categories')
    const cats = await cat.json()


    const posturl = context.params.blogsSlug;
    const res = await fetch(`https://coral-app-2-a333o.ondigitalocean.app/api/post/${posturl}`)
    const posts = await res.json()

    const getfeedback = await fetch(`https://coral-app-2-a333o.ondigitalocean.app/api/posts/feed/${posturl}`)
...
const submitFeedback = async (event) => {
    ...
    xhr.open('POST', 'https://coral-app-2-a333o.ondigitalocean.app/api/feedback/');
