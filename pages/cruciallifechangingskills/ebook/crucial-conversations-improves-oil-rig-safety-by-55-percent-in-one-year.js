        ...
        xhttp.onreadystatechange = function () {
            if (xhttp.readyState == 4) {
                if (xhttp.status == 200) {
                    ...
                    setTimeout(function() {
                        window.open("/classets/pdf/crucial-conversations-improves-oil-rig-safety-by-55-percent-in-one-year-form.pdf", "_blank")
                     }, 3000);
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12 left-about-area ptt-70 pbb-70 text-center">
                        <h1>Crucial Conversations improves oil rig Safety by 55 percent in one year - Crucial Life-Changing Skills</h1>
                ...
                <div class="col-md-12 form-area ptt-10">
                    <form id="contactForm" class="row formb" onSubmit={EbookForm}>
                        ...
                        <div className="col-sm-12 mb-12 d-none">
                           <input type="checkbox" name="ebookname" value="Crucial Conversations improves oil rig Safety by 55 percent in one year - Crucial Life-Changing Skills"/> 
                        </div>   
