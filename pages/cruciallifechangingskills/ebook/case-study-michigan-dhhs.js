        ...
        xhttp.onreadystatechange = function () {
            if (xhttp.readyState == 4) {
                if (xhttp.status == 200) {
                    ...
                    setTimeout(function() {
                        window.open("/classets/pdf/case-study-michigan-dhhs.pdf", "_blank")
                     }, 3000);
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12 left-about-area ptt-70 pbb-70 text-center">
                        <h1>Case Study Michigan DHHS</h1>
                        
                        <p className='colorb'>
                        Online learning gets a bad rap—and deservedly so. For decades eLearning has been clunky, ugly, awkward, difficult to use, boring, and just plain ineffective. For years, we saw the live classroom as the only place where complex interpersonal behaviors could be taught well. Like most, we believed:
                        </p>
                ...
                <div class="col-md-12 form-area ptt-10">
                    <form id="contactForm" class="row formb" onSubmit={EbookForm}>
                        ...
                        <div className="col-sm-12 mb-12 d-none">
                           <input type="checkbox" name="ebookname" value="Case Study Michigan DHHS"/> 
                        </div>   
