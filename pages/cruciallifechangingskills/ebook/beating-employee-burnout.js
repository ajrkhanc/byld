...
export default function Ebook(){
        ...
        xhttp.onreadystatechange = function () {
            if (xhttp.readyState == 4) {
                if (xhttp.status == 200) {
                    ...
                    setTimeout(function() {
                        window.open("/classets/pdf/beating-employee-burnout-ebook.pdf", "_blank")
                     }, 3000);
    ...
    return(
        <>
        <Head>
            <title>Beating Employee Burnout - Crucial Life-Changing Skills</title>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12 left-about-area ptt-70 pbb-70 text-center">
                        <h1>Beating Employee Burnout</h1>
                        
                        <p className='colorb'>
                        Odds are high you’ve heard one or more of these phrases from a coworker. Odds are high you’ve heard one from yourself!
                        </p>
                        <p className='colorb'>
                        According to a new study of 1,110 people by Crucial Learning, a quarter of the workforce is burned out. Many more are tired, disengaged and unmotivated. With all the upheavel brought on by the pandemic and other issues, these feelings are understandable. But that doesn’t mean they’re unsolvable!
                        </p>
                ...
                <div class="col-md-12 form-area ptt-10">
                    <form id="contactForm" class="row formb" onSubmit={EbookForm}>
                        ...
                        <div className="col-sm-12 mb-12 d-none">
                           <input type="checkbox" name="ebookname" value="Beating Employee Burnout"/> 
                        </div>   
