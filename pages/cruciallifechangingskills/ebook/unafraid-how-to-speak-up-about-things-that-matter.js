...
export default function Ebook(){
        ...
        xhttp.onreadystatechange = function () {
            if (xhttp.readyState == 4) {
                if (xhttp.status == 200) {
                    ...
                    setTimeout(function() {
                        window.open("/classets/pdf/ebook-unafraid-cl.pdf", "_blank")
                     }, 3000);
    ...
    return(
        <>
        <Head>
            <title>UNAFRAID HOW TO SPEAK UP ABOUT THINGS THAT MATTER - Crucial Life-Changing Skills</title>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12 left-about-area ptt-70 pbb-70 text-center">
                        <h1>UNAFRAID HOW TO SPEAK UP ABOUT THINGS THAT MATTER</h1>
                        <h6 className='colorb'>HAVE YOU FELT MORE AFRAID TO SPEAK YOUR MIND LATELY? YOU’RE NOT ALONE.</h6>
                        <p className='colorb'>
                ...
                <div class="col-md-12 form-area ptt-10">
                    <form id="contactForm" class="row formb" onSubmit={EbookForm}>
                        ...
                        <div className="col-sm-12 mb-12 d-none">
                           <input type="checkbox" name="ebookname" value="UNAFRAID HOW TO SPEAK UP ABOUT THINGS THAT MATTER"/> 
                        </div>   
