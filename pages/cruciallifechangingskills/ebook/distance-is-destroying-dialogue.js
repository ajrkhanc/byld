...
export default function Ebook(){
        ...
        xhttp.onreadystatechange = function () {
            if (xhttp.readyState == 4) {
                if (xhttp.status == 200) {
                    ...
                    setTimeout(function() {
                        window.open("/classets/pdf/distancedestroysdialogue-ebook-1.pdf", "_blank")
                     }, 3000);
    ...
    return(
        <>
        <Head>
            <title>DISTANCE IS DESTROYING DIALOGUE - Crucial Life-Changing Skills</title>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12 left-about-area ptt-70 pbb-70 text-center">
                        <h1>DISTANCE IS DESTROYING DIALOGUE</h1>
                        ...
                        <p className='colorb'>
                        In this guide, we outline six tips to holding conversations virtually. Teams that feel enabled and encouraged to speak up when they have questions, see concerns, or want to share a new perspective are more motivated, engaged, and productive.
                        </p>
                    </div>
                ...
                <div class="col-md-12 form-area ptt-10">
                    <form id="contactForm" class="row formb" onSubmit={EbookForm}>
                        ...
                        <div className="col-sm-12 mb-12 d-none">
                           <input type="checkbox" name="ebookname" value="DISTANCE IS DESTROYING DIALOGUE"/> 
                        </div>   
