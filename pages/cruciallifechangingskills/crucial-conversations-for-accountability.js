                ...
                <div class="row video-section course-video">
                    <div class="col-md-6 offset-md-3">
                        <div class="row video-area">
                            <iframe width="768" height="432" src="https://www.youtube.com/embed/1rpF0Bkacnw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-4">
                        <div class="row feature-right">
                            ...
                            <div class="col-md-10 feature-content">
                                ...
                                <p>Rather than using coercion, use motivation to drive people.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="row feature-right">
                            ...
                            <div class="col-md-10 feature-content">
                                ...
                                <p>Make every conversation an accountable discussion rather than a conflictive argument through a corporate training program</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="row feature-right">
                            ...
                            <div class="col-md-10 feature-content">
                                ...
                                <p>Make every crucial conversation change its course to better outcomes.</p>
                            </div>
                        </div>
                    </div>
                </div>
