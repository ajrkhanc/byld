                ...
                <div class="col-md-6 form-area ptt-10">
                    <form id="contactForm" class="row formb" onSubmit={WorkshopsForm}>
                        ...
                        <select name='slot' required>
                            ...
                            <option value="Webinar- September 21st, 2022">Webinar- September 21st, 2022</option>
                            <option value="Workshop- September 21st, 2022">Workshop- September 21st, 2022</option>                            
                        </select>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 workshop-col"> 
                       <div class="row workshop-row"> 
                            ...
                            <h6><i class="fa fa-calendar" aria-hidden="true"></i> September 21st 2022</h6>
                    ...
                    <div class="col-md-4 workshop-col"> 
                       <div class="row workshop-row"> 
                            ...
                            <p>for Accountability</p>
                             ...
                             <div class="col-md-12 workshop-date"> 
                            <h6><i class="fa fa-calendar" aria-hidden="true"></i> October 20th - 21st, 2022</h6>
