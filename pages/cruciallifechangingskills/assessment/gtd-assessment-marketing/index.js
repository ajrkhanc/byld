...
export default function Home() {
    ...
    const submitF = async (event) => {
        ...
        xhr.open('POST', 'https://clblogs-zavr.onrender.com/api/assesmentf');
        ...
        var Assessment ="GTD Assessment Form Marketing"
            ...
            <Head>
                ...
                <script
                    dangerouslySetInnerHTML={{
                        __html: `
                        window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'G-FMDLS718VG');
          `,
                    }}
                />
