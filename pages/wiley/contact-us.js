...
export default function Blog(){
    return(
        <>
        <Head>
            <title>Contact Us - Wiley</title>
            <meta name="description" content="Contact Us BYLD Group: Plot 48, 2nd and 3rd Floor, Sector – 44, Opp. EPF Regional Office, Gurugram, Haryana – 122003 1800-102-1345 assessments.info@byldgroup.com We are available between 9am – 6pm from Monday to Friday."/> 
        </Head>
                ...
                <div className="container">
                    <div className="row service-wrap mr-0 ml-0">
                        <div className="col-lg-4 padding-0">
                            <div className="service-grid">
                                <div className="service-icon mb-23">
                                    <img src="/wileyassets/img/icon/call.png" alt=""/>
                                </div>
                        ...
                        <div className="col-lg-4 padding-0">
                            <div className="service-grid">
                                <div className="service-icon mb-23">
                                <img src="/wileyassets/img/icon/email.png" alt=""/>
                                </div>
                        ...
                        <div className="col-lg-4 padding-0">
                            <div className="service-grid br-none bdru">
                                <div className="service-icon mb-23">
                                <img src="/wileyassets/img/icon/map.png" alt=""/>
                                </div>
