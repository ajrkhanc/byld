                    ...
                    <div className="col-md-2 col-sm-6 md-mb-10 pl-55 md-pl-15">
                        ...
                        <div className="col-md-3 col-sm-6">
                            ...
                            <ul className="footer-social md-mb-30">  
                                  ...
                                  <li> 
                                     <a href="https://www.youtube.com/@BYLDexperientiallearning" target="_blank"><span><i className="fa fa-youtube"></i></span></a> 
                                  </li>
                                  <li> 
                                      <a href="https://instagram.com/byld_experientiallearning?igshid=YmMyMTA2M2Y= " target="_blank"><span><i className="fa fa-instagram"></i></span></a> 
                                  </li>
