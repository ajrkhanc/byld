            ...
            <header id="rs-header" className="rs-header style2 header-transparent">                
                        ...
                        <div className="row-table">
                            <div className="col-cell header-logo">                                  
                                <div className="logo-area">
                                    <a href="/everythingdisc">
                                        <img src="/edassets/img/ed-lg.png" alt="logo"/>  
                                    </a>
                                </div>
                            </div>
                                    ...
                                    <div className="main-menu">
                                        <nav className="rs-menu hidden-md">
                                            <ul className="nav-menu">
                                                <li>
                                                    <a href="/everythingdisc">Home</a>                                                    
                                                </li>
                                                
                                                <li className="menu-item-has-children">
                                                    <a href="/everythingdisc/solutions">Our Solutions</a>
                                                    <ul className="sub-menu">
                                                        <li><a href="/everythingdisc/solutions/everything-disc-agile-eq">Everything DiSC Agile EQ</a></li>
                ...
                <nav className="right_menu_togle hidden-md">
                    ...
                    <div className="canvas-logo">
                        <a href="/everythingdisc"><img src="/edassets/img/ed-lg.png" alt="logo"/></a>
                    </div>                    
